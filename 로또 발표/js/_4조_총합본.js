  ...
  setTimeout(() => {
    switch (interSect.length) {
      case 7:
        ...
        alert("1등입니다! 로또 당첨을 축하드립니다! 당신은 행운의 주인공입니다.");
        break;
      case 6:
        numsWinorNot.textContent = alert("2등입니다! 로또 당첨을 축하드립니다!");
        break;
      case 5:
        numsWinorNot.textContent = alert("3등입니다! 로또 당첨을 축하드립니다!");
        break;
      case 4:
        numsWinorNot.textContent = alert("4등입니다! 로또 당첨을 축하드립니다!");
        break;
      default:
        numsWinorNot.textContent = alert("아쉽게도 꽝입니다. 다음 기회를 노려주세요.");
        break;
    }
